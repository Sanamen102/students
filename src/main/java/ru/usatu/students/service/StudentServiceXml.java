...
public class StudentServiceXml implements StudentService{
    ...
    private static final String FILE_PATH = "C:\\Users\\pozid\\OneDrive\\Рабочий стол\\Учеба от слова чорт\\Интернет программирование\\students\\src\\main\\resources\\students.xml";
